...
INT32	CCSCfgMgr::LoadNPCCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NPCCfg.xml";
	ptree cPtree;
	ptree cNPCCfg;
	try{
...
INT32	CCSCfgMgr::LoadHeroCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/HeroCfg.xml";
	ptree cPtree;
	ptree cHeroCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/HeadSelect.xml";
	ptree cPtree;
	ptree cLogicCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadMapLogicCfg(){
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/MapLoadCfg.xml";
	ptree cPtree;
	ptree cLogicCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadGoodsCfg()
{
	...
	{
		std::string cpszCombineFilename = m_strExeDir + "./CSBattleMgr/CombineCfg.xml";
		ptree cPtree;
		ptree cComposeCfg;
		try{
			read_xml(cpszCombineFilename.c_str(), cPtree, xml_parser::trim_whitespace);
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/ItemCfg.xml";
	ptree cPtree;
	ptree cGoodsCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadShopCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/ShopCfg.xml";
	ptree cPtree;
	ptree cShopCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32	CCSCfgMgr::LoadVoipCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/VoipCfg.xml";
	ptree cPtree;
	ptree cCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadNewSkillCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_manager.xml";
	ptree cPtree;
	ptree cSkillCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadSkillModelAccountCfg(){
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_account.xml";
	ptree cPtree;
	ptree cSkillCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadSkillModelLeadingCfg(){
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_leading.xml";
	ptree cPtree;
	ptree cSkillCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadSkillModelEmitCfg(){
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_emit.xml";
	ptree cPtree;
	ptree cSkillCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_area.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_buff.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_summon.xml"; 
	ptree cPtree;
	ptree cSkillCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_move.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_switch.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_purification.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_links.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_passitive.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_bloodseek.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_rebound.xml";
...
{
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/NewSkill/SkillCfg_relive.xml";
...
INT32 CCSCfgMgr::LoadFilterWordsCfg(){
	const string fileName = m_strExeDir + "./CSConfig/Chatfilter.txt";
...
INT32 CCSCfgMgr::LoadHeroChooseCfg(){
	...
	std::string cpszfilename = m_strExeDir +"./CSBattleMgr/HeroChooseCfg.xml";
	ptree cPtree;
	ptree cHeroCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
INT32 CCSCfgMgr::LoadRobotAICfg(){
	...
	DoLoadRobotAICfg(eRobotAIType_Guide,(m_strExeDir + "./CSBattleMgr/RobotAICfg.xml").c_str());
	DoLoadRobotAICfg(eRobotAIType_PvE, (m_strExeDir + "./CSBattleMgr/RobotAICfg.xml").c_str());
	DoLoadRobotAICfg(eRobotAIType_Match, (m_strExeDir + "./CSBattleMgr/RobotAICfg.xml").c_str());
...
INT32 CCSCfgMgr::LoadRobotAIPathCfg(){
	...
	std::string cpszfilename = m_strExeDir + "./CSBattleMgr/RobotPath.xml";
	ptree cPtree;
	ptree cHeroCfg;
	try{
		read_xml(cpszfilename.c_str(), cPtree, xml_parser::trim_whitespace);
...
{
	const string fileName = m_strExeDir + "./CSConfig/AiRobotName.txt";
	std::ifstream in(fileName, std::ios::in | std::ios::binary);
